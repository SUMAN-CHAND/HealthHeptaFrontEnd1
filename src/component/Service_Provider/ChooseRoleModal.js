        ...
        <>
            ...
            <div className="clinic choose-role-div" >
                ...
                <div className=" shadow m-3 p-3" style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', fontWeight: '700', color: 'white', backgroundColor: '#1c98b3', borderRadius: '5px' }}>
                    <div id='mob-chooserole-lable' className="form-check mob-chooserole-lable m-2 p-2" style={{ cursor: 'pointer' }}>
                        ...
                        <label className="label" htmlFor="doctor" style={{ display: 'flex', cursor: 'pointer' }}>
                            <input
                                type="radio"
                                name="role"
                                id="doctor"
                    ...
                    <div id='mob-chooserole-lable' className="form-check mob-chooserole-lable  m-2 p-2" style={{ cursor: 'pointer' }}>
                        ...
                        <label className="form-check-label" htmlFor="Medicine Shop" style={{ display: 'flex', cursor: 'pointer' }}>
                            <input
                                type="radio"
                                name="role"
                                id='Medicine Shop'
                    ...
                    <div id='mob-chooserole-lable' className="form-check mob-chooserole-lable  m-2 p-2" style={{ cursor: 'pointer' }}>
                        ...
                        <label className="form-check-label" htmlFor="laboratory" style={{ display: 'flex', cursor: 'pointer' }}>
                            <input
                                type="radio"
                                name="role"
                                id='laboratory'
                    ...
                    <div id='mob-chooserole-lable' className="form-check mob-chooserole-lable  m-2 p-2" style={{ cursor: 'pointer' }}>
                        ...
                        <label className="form-check-label" htmlFor="clinic" style={{ display: 'flex', cursor: 'pointer' }}>
                            <input
                                type="radio"
                                name="role"
                                id='clinic'
