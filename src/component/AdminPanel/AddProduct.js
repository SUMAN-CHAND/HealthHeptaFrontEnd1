...
export default function AddProduct() {
    ...
    const handleSubmit = (event) => {
        ...
        axiosClient.post(`/superadmin/addproduct`, values)
            .then(res => {
                if (res.data === 'success') {
            ...
            <div className="container mt-3" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div className='bg-white m-3 pt-3 pl-2 rounded w-30 shadow' style={{ minWidth: '40vw', height: '110%' }}>
                    <form action='submit' onSubmit={handleSubmit} style={{ padding: '1vw' }}>
                        ...
                        <div className=' p-1' style={{ textAlign: 'initial', fontWeight: '700' }} >
                            <label className='p-1' htmlFor="product_dec">Product Full Description <span style={{fontSize:'9px',color:'red'}}>(Product Name ,Brand Name, Moluqule name ,what is product do?)</span> : </label><br></br>
                            <input required className='m-2 p-1' type="text-area" style={{ width: '90%' }} placeholder='Enter Product Full Description'
