...
export default function AddNewDeliveryPartnerCommission() {
    ...
    const handleSubmit = (event) => {
        ...
        axiosClient.post(`/superadmin/delivery/add-commission`, values)
            .then(res => {
                if (res.data === 'success') {
                    ...
                    <form action='submit' onSubmit={handleSubmit} style={{ padding: '1vw' }}>
                        ...
                        <div className=' p-1' style={{ textAlign: 'initial', fontWeight: '700' }} >
                            ...
                            <select
                                ...
                                <option value="Medicine Order">Medicine Delivery</option>
