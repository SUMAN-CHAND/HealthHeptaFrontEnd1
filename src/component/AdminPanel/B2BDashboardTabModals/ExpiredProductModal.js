...
export default function ExpiredProductModal({ closeTheModal }) {
    const [products, setProducts] = useState([]);
    const [ind_product_Images, setInd_product_Images] = useState([]);


    useEffect(() => {
        axiosClient.get(`/superadmin/product-details/expired`)
            .then(response => {
                // Handle response
        ...
        <>
            <div style={customStyles}>
                ...
                <div className="" id="list-products">
                    <span style={{ display: 'flex', justifyContent: 'space-between' }}><h2 className='p-2 mx-3'>|| Expired Products ||</h2> <Link to='addproduct'><button className='btn btn-primary mx-3 my-2' >Add New</button></Link></span>
