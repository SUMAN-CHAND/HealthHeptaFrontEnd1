        ...
        <div className="container" >
          ...
          <img src={`http://${process.env.REACT_APP_HOST}:8081/${props.imgpath}`} className="card-img-top" alt="..." style={{ maxHeight: '13vh' }}  />
            <div className="card-body">
              ...
              <p className="card-text"  style={{fontSize:'0.9rem' , marginBottom:'2px'}}>{props.clnics}</p>
              <p className="card-text"  style={{fontSize:'0.9rem' , marginBottom:'2px'}}>{props.clinic_descs}</p>
              <p className="card-text"  style={{fontSize:'0.9rem' , marginBottom:'2px'}}>{props.location}</p>
