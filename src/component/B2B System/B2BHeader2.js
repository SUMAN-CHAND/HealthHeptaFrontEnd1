            ...
            <nav className="navbar navbar-expand-lg" style={{ backgroundColor: "#232f3e"}}>
                <div className="container-fluid Header-2" style={{ justifyContent: 'space-evenly' }}>
                    ...
                    <div className="nav-item2 text-white mx-1 Header2-search " style={{ display: 'flex', justifyContent: 'start',alignItems:'center' }}>
                        ...
                        <Link className="nav-link active text-white h2-t " style={fontStyle} aria-current="page" onClick={openModal}>Shop By Cartagory</Link>
                        <Modal
                            isOpen={modalIsOpen}
                    ...
                    <img src={medicinesImage} alt="" />
                        <Link className="nav-link active text-white h2-t  " style={fontStyle} aria-current="page" onClick={openModal}>Quick Orders</Link>
                        <Modal
                            isOpen={modalIsOpen}
                            onAfterOpen={afterOpenModal}
                            onRequestClose={closeModal}
                    ...
                    <div className="nav-item text-white Header2-search">
                    <img src={medicinesImage} alt="" />
                        <Link className="nav-link active text-white h2-t  " style={fontStyle} aria-current="page" onClick={openModal}>Best Deals</Link>
                        <Modal
                            isOpen={modalIsOpen}
                            onAfterOpen={afterOpenModal}
                            onRequestClose={closeModal}
                    ...
                    <img src={labTestImage} alt="img...." />
                        <Link className="nav-link active text-white h2-t " style={fontStyle} aria-current="page" onClick={openModal} >My Orders</Link>
                        <Modal
                            isOpen={modalIsOpen}
                            onAfterOpen={afterOpenModal}
                            onRequestClose={closeModal}
                    ...
                    <img src={clinicImage} alt="" />
                        <Link className="nav-link active text-white h2-t " style={fontStyle} aria-current="page" onClick={openModal}>Contact us</Link>
                        <Modal
                            isOpen={modalIsOpen}
                            onAfterOpen={afterOpenModal}
                            onRequestClose={closeModal}
